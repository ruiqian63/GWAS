...
bcftools view -S post_folate_iids.txt -Oz -o post_folate.vcf.gz merged_1.vcf.gz
bcftools view -S pre_folate_iids.txt -Oz -o pre_folate.vcf.gz merged_1.vcf.gz
